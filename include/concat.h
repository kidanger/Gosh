 ...
 *  @date 08/02/2014
 *  @ingroup outils
 *  @brief Macro permettant de concaténer les arguments passés en paramètres.
...
/** @def CONCAT_3(a,b,c)
 *  @ingroup outils
 *  @brief Concatène les trois arguments passés en paramètres.
 */
...
/** @def CONCAT_2(a,b)
 *  @ingroup outils
 *  @brief Concatène les deux arguments passés en paramètres.
 */
